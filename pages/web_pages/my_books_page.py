...
class MyBooksPage:
    def __init__(self, page: Page, book: Book):
        ...
        self.my = page.get_by_role("tab", name="Мои").get_by_test_id("navigation__tabItem__link")
        self.postponed = page.get_by_role("tab", name="Отложено").get_by_test_id("navigation__tabItem__link")
        self.cloud = page.get_by_role("tab", name="Облако").get_by_test_id("navigation__tabItem__link")
        self.lists = page.get_by_role("tab", name="Списки").get_by_test_id("navigation__tabItem__link")
        self.i_follow = page.get_by_role("tab", name="Я слежу").get_by_test_id("navigation__tabItem__link")
        ...
        self.archive = page.get_by_role("tab", name="Архив").get_by_test_id("navigation__tabItem__link")
    ...
    def my_books_tab(self):
        ...
        expect(self.my).to_have_attribute("aria-selected","true")
        allure_screenshot(self.page)
    ...
    def postponed_books_tab(self):
        ...
        self.page.wait_for_timeout(1000)
        expect(self.postponed).to_have_attribute("aria-selected","true")
        allure_screenshot(self.page)
    ...
    def cloud_tab(self):
        self.cloud.click()
        self.page.wait_for_timeout(1000)
        expect(self.cloud).to_have_attribute("aria-selected", "true")
        allure_screenshot(self.page)
    ...
    def lists_tab(self):
        self.lists.click()
        self.page.wait_for_timeout(1000)
        expect(self.lists).to_have_attribute("aria-selected", "true")
        allure_screenshot(self.page)
    ...
    def i_follow_tab(self):
        self.i_follow.click()
        self.page.wait_for_timeout(1000)
        expect(self.i_follow).to_have_attribute("aria-selected", "true")
        allure_screenshot(self.page)
